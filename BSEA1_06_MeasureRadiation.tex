...
コイルのインダクタンス$L$と抵抗値$R$の測定結果を表\ref{tb:measure-result}に, 与えられた4つの抵抗の抵抗値の測定結果を表\ref{tb:resistor-values}に示す.
...
近直線の傾きの大きさは$-0.003020\mathrm{V}/${\textmu}sであった.
...
近直線の傾きの大きさは$-0.005466\mathrm{V}/${\textmu}sであった.
...
近直線の傾きの大きさは$-0.009285\mathrm{V}/${\textmu}sであった.
...
近直線の傾きの大きさは$-0.005279\mathrm{V}/${\textmu}sであった.
