...
y = np.array([0,-0.363965377,-0.710241614,-1.033015006,-1.438480114,-1.774952351,-2.131627295,-2.691243083])
...
plt.text(200, -3.2, f'y = {slope:.6f}x + {intercept:.6f}', fontsize=12)
